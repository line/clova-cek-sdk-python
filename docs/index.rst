...
For a detailed example, see `clova-cek-sdk-python-sample`_ example extension.
See also the API documentation to know how to use the SDK.

.. _`clova-cek-sdk-python-sample`: https://github.com/line/clova-cek-sdk-python-sample
